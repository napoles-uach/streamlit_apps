...
st.sidebar.markdown("[Generalized Neural-Network Representation of High-Dimensional Potential-Energy Surfaces]\
(http://cacs.usc.edu/education/cs653/Behler-NNPES-PRL07.pdf)")
