...
![texto alternativo](https://github.com/napoles-uach/figuras/blob/master/nn.png?raw=true?raw=true)

In the nodes of the input layer the two generalized coordinates $G_i^1$ and $G_i^2$ that determine the energy of configuration $i$ are provided.
')
